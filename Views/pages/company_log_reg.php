          ...
          <div class="tab-content">
            <div id="register-account" class="tab-pane fade in active white-text">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 zero-padding-left">
                ...
                <form name="contact_us" class="contact_us" action="<?= BASE_URL ?>company/register" method="post">
                  ...
                  <div class="form-group">
                    <label>Email:</label>
                    <input type="email" name="email" data-validacion-tipo="requerido|max:75|email" maxlength="75" required>
                    <span class="err white-text"></span>
                  </div>
                  <div class="form-group">
                    <label>Categoría:</label>
                    <select name="categoria" class="form-control item-list login" required>
                  ...
                  <div class="form-group">
                    <label>Clave:</label>
                    <input type="password" name="passwd" id="password" data-validacion-tipo="requerido|min:6|max:16" required/>
                    <span class="err white-text"></span>
                  </div>
                  <div class="form-group">
                    <label><small id="err" class="white-text"></small> Confirmar Clave:</label>
                    <input type="password" name="cpassword" id="cpassword" data-validacion-tipo="requerido|min:6|max:16" required/>
                    <span class="err white-text"></span>
                  </div>
              ...
              <div class="col-lg-4 col-md-5 col-sm-6 col-xs-12  pull-right sidebar">
                <div class="widget">
                  ...
                  <ul>
                    <li><p class="text-justify"><i class="fa fa-clock-o"></i>Publicación rápida de ofertas.</p></li>
                    <li><p class="text-justify"><i class="fa fa-child"></i>Ser objetivo de muchos candidatos.</p></li>
                    <li><p class="text-justify"><i class="fa fa-check-circle-o"></i>Sugerimos candidatos que se ajustan
                      a las necesidades de cada oferta.</p></li>
                  </ul>
                </div>
              </div>
            </div>
            <div id="login" class="tab-pane fade in  white-text">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 zero-padding-left">
                ...
                <form name="contact_us" class="contact_us" action="<?= BASE_URL ?>company/login_user" method="post">
                  <div class="form-group">
                    <label>Email:</label>
                    <input type="email" name="email" data-validacion-tipo="requerido|max:75|email" required>
                    <span class="err white-text"></span>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group submit">
                    ...
                    <a href="<?= BASE_URL?>company/lost_password" class="lost_password">¿Olvidó la clave?</a>
                  </div>
                </form>
              </div>
              <div class="col-lg-4 col-md-5 col-sm-6 col-xs-12  pull-right sidebar">
